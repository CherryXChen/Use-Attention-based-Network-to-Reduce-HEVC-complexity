...
MODEL_FILE = '/scratch/user/cherryxchen/HEVC/Inter_Pred/ETH-CNN_Training_LDP/Models/model_20190306_215602_1000000_qp22~37.dat'
INPUT_PATH = '/scratch/user/cherryxchen/HEVC/Inter_Pred/ETH-LSTM_Training_LDP_test/4to1_real/'
INPUT_NAME_LIST = ['resi_BlowingBubbles_416x240_50_8982.dat']
OUTPUT_PATH = '/scratch/user/cherryxchen/HEVC/Inter_Pred/ETH-LSTM_Training_LDP_test/Test_real/'
OUTPUT_NAME_ROOT_LIST = ['resi_BlowingBubbles_416x240_50.dat']
# ----------------------------------------------------------------------------------------------------------------------
...
# 以上为分配指针
            ...
            while index_end_in_batch < num_samples:
                if is_init == True:
                    ...
                    index_end_in_batch = BATCH_SAMPLES # 20000
                else:
                    index_start_in_batch += BATCH_SAMPLES_SWAP #5000
                ...
                #data_new: pointer > 64 + (1+16+64*64) * i(0/1/2/3)
