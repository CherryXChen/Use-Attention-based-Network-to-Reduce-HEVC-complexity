...
DATA_PATH = '/scratch/user/cherryxchen/HEVC/Inter_Pred/ETH-LSTM_Training_LDP_test/Test_Video/'
...
def get_train_valid_test_sets(DATA_SWITCH):
    ...
    if DATA_SWITCH == 1: # switch to other files
        TRAINSET = 'resi_BasketballDrill_832x480_50_8736.dat_lstm_4qps'
        VALIDSET = 'resi_BasketballDrill_832x480_50_8736.dat_lstm_4qps'
        TESTSET  = 'resi_Traffic_2560x1600_30_28000.dat_lstm_4qps'
...
def get_data_set(file_reader, num_samples, is_loop=False):
    ...
    print(num_samples*(LSTM_MAX_LENGTH*VECTOR_LENGTH*4+64+LSTM_MAX_LENGTH*4+LSTM_MAX_LENGTH*NUM_LABEL_BYTES*4))
