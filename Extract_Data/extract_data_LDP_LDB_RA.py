...
if CONFIG == 'LDP': # Low-Delay-P
    YUV_PATH_RESI = '/scratch/user/cherryxchen/HEVC/Inter_Pred/HM-16.5_Resi_Pre/bin/' # path storing resi_XX.yuv files
    INFO_PATH = '/scratch/user/cherryxchen/HEVC/Inter_Pred/LDP_Info/' # path storing Info_XX.dat files
...
if __name__ == '__main__':
    ...
    '''
    shuffle_samples('LDP_Train_9011161.dat', 16516*89)
    shuffle_samples('LDP_Test_1896004.dat', 16516*4)
    shuffle_samples('LDP_Valid_1057660.dat', 16516*10)